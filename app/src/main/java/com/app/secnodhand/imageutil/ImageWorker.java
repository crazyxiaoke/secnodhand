...
package com.app.secnodhand.imageutil;
...
import com.app.secnodhand.imageviewer.ZoomableImageView;
...
public abstract class ImageWorker {
	...
	public void loadImage(Object data, ImageView imageView,
		...
		if (value != null) {
			...
			Log.d("driverInfo", "value:" + value);
			imageView.setImageDrawable(value);
			if (mImageLoadingListener != null) {
				mImageLoadingListener.finishLoading();
			}
	...
	public void loadImageForView(Object data, ZoomableImageView view,
			ImageLoadingListener mImageLoadingListener) {
		if (data == null) {
			return;
		}
	...
	/**
	 * Adds an {@link ImageCache} to this {@link com.app.secnodhand.imageutil.ImageWorker} to handle disk and
	 ...
	 *            {@link com.app.secnodhand.imageutil.ImageWorker#loadImage(Object, android.widget.ImageView)}
	...
	public static boolean cancelPotentialWork(Object data, ImageView imageView) {
		...
		if (bitmapWorkerTask != null) {
			...
			if (bitmapData == null || !bitmapData.equals(data)) {
				bitmapWorkerTask.cancel(true);
				if (BuildConfig.DEBUG) {
					Log.e(TAG, "cancelPotentialWork - cancelled work for "
							+ data + ",----originaldata=" + bitmapData);
				}
			} else {
	...
	private class BitmapWorkerTask extends
		...
		private WeakReference<ZoomableImageView> zoomableViewReference = null;

		public BitmapWorkerTask(ImageView imageView) {
			imageViewReference = new WeakReference<ImageView>(imageView);
		}

		public BitmapWorkerTask(ZoomableImageView view) {
			zoomableViewReference = new WeakReference<ZoomableImageView>(view);
		}
		...
		protected BitmapDrawable doInBackground(Object... params) {
			...
			if (mImageCache != null
					&& !isCancelled()
					&& (zoomableViewReference != null || getAttachedImageView() != null)
					&& !mExitTasksEarly) {
		...
		protected void onPostExecute(BitmapDrawable value) {
			...
			if (imageViewReference != null) {
				...
				ZoomableImageView zoomView = zoomableViewReference.get();
				if (value != null && zoomView != null) {
					zoomView.setImageBitmap(((BitmapDrawable) value)
							.getBitmap());
				}
			}
